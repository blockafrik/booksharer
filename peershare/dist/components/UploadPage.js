...
var UploadPage = function (_React$Component) {
  ...
  _createClass(UploadPage, [{
    ...
    key: 'publishtoBlockchain',
    value: function publishtoBlockchain(datalink1) {

      datalink1 = "http://localhost:3000/" + this.state.token;
      alert(this.state.token);
      _axios2.default.post('http://localhost:3001/mineBlock', {
        "data": datalink1
          ...
          return _react2.default.createElement(
            ...
            _react2.default.createElement(
              ...
              _react2.default.createElement(
                'p',
                null,
                'Peer-to-peer blockchain book sharing platform'
              ),
              _react2.default.createElement(
                'p',
                null,
                _react2.default.createElement(
                  ...
                  _react2.default.createElement('input', { type: 'file', onChange: this.handleSelectedFile, required: true, accept: '.xlsx,.xls,image/*,.doc, .docx,.ppt, .pptx,.txt,.pdf' }),
                  _react2.default.createElement(
                    'span',
                    null,
                    'select book'
        ...
        case 'uploading':
          return _react2.default.createElement(
            ...
            _react2.default.createElement(
              'p',
              null,
              'Your file has been publish to the blockchain'
            ),
            _react2.default.createElement(
              'p',
              null,
            ...
            _react2.default.createElement(_Tempalink2.default, { token: this.state.token }),
            _react2.default.createElement(
              'button',
              { className: 'button', onClick: this.publishtoBlockchain.bind(this) },
