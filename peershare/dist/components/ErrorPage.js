...
var ErrorPage = function (_React$Component) {
  ...
  function ErrorPage() {
    ...
    _this._onChange = function () {
      _this.setState(_ErrorStore2.default.getState());
    };
    return _this;
  }
  ...
  _createClass(ErrorPage, [{
    ...
    value: function componentDidMount() {
      _ErrorStore2.default.listen(this._onChange);
    }
  }, {
    key: 'componentWillUnmount',
    value: function componentWillUnmount() {
      _ErrorStore2.default.unlisten(this._onChange);
    }
  }, {
    key: 'render',
    value: function render() {
      return _react2.default.createElement(
        ...
        this.state.stack ? _react2.default.createElement(
          'pre',
          null,
          this.state.stack
        ) : null
